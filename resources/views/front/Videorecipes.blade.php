    ...
    <div class="container">
        <div class="row align-items-center">
            ...
            <div class="col-md-3 text-right">
                <input style="direction: rtl; border-radius: 5px; border: 4px solid #fff; width: 100%; box-sizing: border-box; font-size: 16px;" type="search" id="searchQuery" placeholder="🔍 بحث">
            </div>
        </div>
    </div>
</section>
        ...
        <div class="col-md-12 " >
             ...
             <source src="front-assets/images/num.mp4" type="video/mp4">
                ...
                <div class="card-body" style="background: #F2F2F2;">
                    <h5 class="card-title" style="text-align: right;font-size: 50px; color:red;">وجبة 2  </h5>
                    <p class="card-tex" style="text-align: right;font-size: 30px; color:#007329">.موسبيإ ميرول صن نم خسن ىلع اًضيأ توح يتلاو ركيام جياب سودلأ لثم ينورتكلإلا رشنلا</p>
...
<h5 class="card-title" style="font-size: 50px; color: #75C425; display: flex; justify-content: center;    padding-top: 23px;">طريقة التحضير</h5>
            ...
            <div class="card bg-white">
                <div class="card-body" style="background-color: #75C425;">
                    ...
                    <div class="border-green p-2" style="font-size: 25px;">
                        <p style="color: white;direction: ltr;text-align: right;" >.موسبيإ ميرول صن نم خسنىلع اًضيأ توح يتلاو ركيام جياب سودلألثم ينورتكلإلا رشنلا</p>
                    </div>
                </div>
            </div>
        </div>
