            ...
            <div class="centered-logo" id="centered-logo"
                ...
                <div class="overlay">
                    <div>
                        ...
                        <p class="" style="color: white;font-size: 18px;">DEVELOPED BY <a
                                href="https://peaklink.sy/">PEAK LINK</a> </p>
                    </div>
                </div>
            </div>
            <!-- الصور الجانبية والخلفية -->
            <img src="{{ asset('front-assets/images/Vector 1.png') }}" alt="Background Image" class="background-image">
            <img src="{{ asset('front-assets/images/Asset 3 1.png') }}" alt="Footer Image Left"
                class="side-image left-image">
            <img src="{{ asset('front-assets/images/Asset 2 1.png') }}" alt="Footer Image Right"
